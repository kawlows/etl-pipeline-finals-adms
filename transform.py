...
def transform_data():
    ...
    try:
        ...
        jpy_to_usd_rate = 1/150  # approximately 0.0067
    ...
    japan_sales = japan_sales.dropna(subset=['id'])  # Remove nulls
    ...
    myanmar_sales = myanmar_sales.dropna(subset=['id'])  # Remove nulls
